...
public final class PropDistanceGT_OBJ_AC3_v2_BIN extends Propagator<IntVar> {
    ...
    public PropDistanceGT_OBJ_AC3_v2_BIN(IntVar F1, IntVar F2, SharedBest best, int[][] dist, int d_lb) {
